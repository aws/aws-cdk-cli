...
integTest(
  ...
  withDefaultFixture(async (fixture) => {
    ...
    const drift = await fixture.cdk(['drift', fixture.fullStackName('driftable-lambda')]);
    ...
    const driftAfterModification = await fixture.cdk(['drift', fixture.fullStackName('driftable-lambda')]);
