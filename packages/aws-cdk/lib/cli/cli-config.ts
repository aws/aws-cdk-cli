    ...
    commands: {
      ...
      init: {
        ...
        options: {
          ...
          'from-path': { type: 'string', desc: 'Path to a local template directory', requiresArg: true },
          'template-path': { type: 'string', desc: 'Path to a specific template within a Git repository or NPM package', requiresArg: true },
          'from-git': { type: 'string', desc: 'Git repository URL containing template(s)', requiresArg: true },
          'from-github': { type: 'string', desc: 'GitHub repository shorthand notation (user/repo) containing template(s)', requiresArg: true },
          'from-npm': { type: 'string', desc: 'NPM package name containing template(s)', requiresArg: true },
          'stack-name': { type: 'string', desc: 'The name of the stack to create', requiresArg: true },
        },
      },
      migrate: {
