    ...
    commands: {
      ...
      init: {
        ...
        options: {
          ...
          'template-path': { type: 'string', desc: 'Path to a local template directory', requiresArg: true },
          'git-url': { type: 'string', desc: 'Git repository URL containing template(s)', requiresArg: true },
          'template-name': { type: 'string', desc: 'Name of the specific template to use when a repository contains multiple templates', requiresArg: true },
          'npm-package': { type: 'string', desc: 'NPM package name containing template(s)', requiresArg: true },
