...
export interface DeployOptions {
  ...
  /**
   * The number of minutes CloudFormation continues to monitor the rollback trigger alarms after the deployment completes, before cleaning up old resources. Must be between 0 and 180. Requires --rollback-trigger-alarm-arns to have any effect.
   *
   * @default - undefined
   */
