...
export function parseCommandLineArguments(args: Array<string>): any {
  return yargs
    ...
    .option('notices', {
      defaultDescription: String(helpers.shouldDisplayNotices()),
      type: 'boolean',
    ...
    .option('ci', {
      defaultDescription: String(helpers.isCI()),
      type: 'boolean',
    ...
    .command('deploy [STACKS..]', 'Deploys the stack(s) named STACKS into your AWS account', (yargs: Argv) =>
      yargs
        ...
        .option('parameters', {
          defaultDescription: '[object Object]',
          type: 'array',
    ...
    .command(['docs', 'doc'], 'Opens the reference documentation in a browser', (yargs: Argv) =>
      yargs.option('browser', {
        defaultDescription: String(helpers.browserForPlatform()),
        alias: 'b',
