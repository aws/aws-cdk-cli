...
import type { ConfirmationRequest, DeploymentMethod, DiagnoseOptions, PublishAssetsOptions, SynthOptions, ToolkitAction, ToolkitOptions, UnstableFeature, ValidateOptions } from '@aws-cdk/toolkit-lib';
...
export class CdkToolkit {
   ...
   * exactly like `cdk deploy --watch`.
   */
  public async synthWatch(options: SynthOptions): Promise<void> {
    const rootDir = path.dirname(path.resolve(PROJECT_CONFIG));
