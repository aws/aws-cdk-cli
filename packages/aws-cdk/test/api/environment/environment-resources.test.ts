...
describe('validateversion without bootstrap stack', () => {
  ...
  test('validating version with explicit SSM parameter succeeds', async () => {
    ...
    const ioHostEmitter = new IoHostEmitter(ioHost, 'notices');
