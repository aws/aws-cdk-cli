...
| `CDK_TOOLKIT_I4000` | Provides diff times. | `info` | {@link Duration} |
| `CDK_TOOLKIT_I4001` | Diff stacks is starting | `trace` | {@link StackSelectionDetails} |
| `CDK_TOOLKIT_I4401` | Output of the diff command | `info` | {@link DiffOutput} |
