...
//           { op: 'replace', path: '/Code/S3Bucket', value: 'current-bucket' },
//           { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//         ]),
//       });
//     },
//   );
...
//       expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//         TypeName: 'AWS::Lambda::Function',
//         Identifier: 'lambda-mybucket-function',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Code/S3Bucket', value: 'current-bucket' },
//           { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//         ]),
...
//         Identifier: 'my-function',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Code/S3Bucket', value: 'asset-bucket' },
//           { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//         ]),
//       });
//     },
...
//       expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//         TypeName: 'AWS::Lambda::Function',
//         Identifier: 'mock-function-resource-id',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Code/S3Bucket', value: 'current-bucket' },
//           { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//         ]),
...
//   test('calls Cloud Control updateResource after function code is updated', async () => {
//     // GIVEN
//     setup.setCurrentCfnStackTemplate({
//       Resources: {
//         Func: {
...
//         Identifier: 'my-function',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Environment', value: { Variables: { Key1: 'Value1', Key2: 'Value2', NewKey: 'NewValue' } } },
//         ]),
//       });
//     },
//   );
...
//         Identifier: 'my-function',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Code/S3Bucket', value: 'new-bucket' },
//           { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//           { op: 'replace', path: '/Description', value: 'New Description' },
//         ]),
//       });
...
//         Identifier: 'my-function',
//         PatchDocument: JSON.stringify([
//           { op: 'replace', path: '/Description', value: 'newValuearn:swa:events:here:123456789012:event-bus/my-event-bus' },
//           { op: 'replace', path: '/Environment', value: { Variables: { token: 'arn:swa:events:here:123456789012:event-bus/my-event-bus', literal: 'newValue' } } },
//         ]),
//       });
//     },
//   );
...
//       PatchDocument: JSON.stringify([
//         { op: 'replace', path: '/Code/S3Key', value: 'new-key' },
//         { op: 'replace', path: '/Code/S3ObjectVersion', value: 'new-obj' },
//       ]),
//     });
//   });
// });
