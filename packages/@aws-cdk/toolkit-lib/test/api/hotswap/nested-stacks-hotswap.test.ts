...
//     setup.addTemplateToCloudFormationLookupMock(
//       testStack({
...
//     setup.pushNestedStackResourceSummaries(
//       'LambdaRoot',
...
//         { op: 'add', path: '/Code/S3Bucket', value: 'current-bucket' },
//         { op: 'add', path: '/Code/S3Key', value: 'new-key' },
//       ]),
//     });
//   });
...
//     expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//       TypeName: 'AWS::Lambda::Function',
//       Identifier: 'child-function',
//       PatchDocument: JSON.stringify([
//         { op: 'add', path: '/Code/S3Bucket', value: 'new-bucket' },
//         { op: 'add', path: '/Code/S3Key', value: 'current-key' },
//       ]),
//     });
//     expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//       TypeName: 'AWS::Lambda::Function',
...
//   test(
//     'hotswappable changes in nested stacks do not override hotswappable changes in their parent stack',
//     async () => {
//       // GIVEN
...
//   test(
//     `non-hotswappable changes in nested stacks result in a full deployment, even if their parent contains a hotswappable change in CLASSIC mode,
...
//   test(
//     `deleting a nested stack results in a full deployment in CLASSIC mode, even if their parent contains a hotswappable change,
...
//   test(
//     `creating a nested stack results in a full deployment in CLASSIC mode, even if their parent contains a hotswappable change,
//         but results in a hotswap deployment in HOTSWAP_ONLY mode`,
//     async () => {
//       // GIVEN
...
//   test(
//     `attempting to hotswap a newly created nested stack with the same logical ID as a resource with a different type results in a full deployment in CLASSIC mode
...
//     expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//       TypeName: 'AWS::Lambda::Function',
//       Identifier: 'grandchild-A-function',
//       PatchDocument: JSON.stringify([
//         { op: 'add', path: '/Code/S3Bucket', value: 'current-bucket' },
//         { op: 'add', path: '/Code/S3Key', value: 'new-key' },
//       ]),
...
//     expect(mockCloudControlClient).toHaveReceivedCommandWith(UpdateResourceCommand, {
//       TypeName: 'AWS::Lambda::Function',
//       Identifier: 'grandchild-B-function',
//       PatchDocument: JSON.stringify([
//         { op: 'add', path: '/Code/S3Bucket', value: 'current-bucket' },
//         { op: 'add', path: '/Code/S3Key', value: 'new-key' },
//       ]),
...
//       Identifier: 'my-function',
//       PatchDocument: JSON.stringify([
//         { op: 'add', path: '/Code/S3Bucket', value: 'bucket-param-value' },
//         { op: 'add', path: '/Code/S3Key', value: 'key-param-value' },
//       ]),
//     });
//   });

//   test(
//     'can hotswap a lambda function in a 2-level nested stack with dependency on an output of 2nd level sibling stack',
//     async () => {
...
//       setup.pushNestedStackResourceSummaries(
//         oldRootStack.stackName,
//         setup.stackSummaryOf(
//           oldFirstLevelNestedStack.stackName,
//           'AWS::CloudFormation::Stack',
...
//         PatchDocument: JSON.stringify([
//           { op: 'add', path: '/Code/S3Bucket', value: 'new-bucket' },
//           { op: 'add', path: '/Code/S3Key', value: 's3-key-value-from-output' },
//         ]),
//       });
//     },
//   );
...
//   test(
//     'can hotswap a lambda function in a 1-level nested stack and read default parameters value if not provided',
//     async () => {
...
//         Identifier: 'my-function',
//         PatchDocument: JSON.stringify([
//           { op: 'add', path: '/Code/S3Bucket', value: 'default-s3-bucket' },
//           { op: 'add', path: '/Code/S3Key', value: 'default-s3-key' },
//         ]),
//       });
//     },
//   );
...
//       Identifier: 'my-function',
//       PatchDocument: JSON.stringify([
//         { op: 'add', path: '/Code/S3Bucket', value: 'child-bucket-param-value' },
//         { op: 'add', path: '/Code/S3Key', value: 'child-key-param-value' },
//       ]),
//     });
//   });
