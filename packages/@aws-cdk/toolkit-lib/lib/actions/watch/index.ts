...
export interface WatchOptions extends BaseDeployOptions {
   ...
   *
   * @defaultValue - all files in the watchDir
   */
   ...
   *
   * @defaultValue - default patterns excluding likely irrelevant files for all CDK supported programming languages, this list will change over time
   */
   ...
   * Deployment method
   *
   * @defaultValue HotswapDeployment
   */
