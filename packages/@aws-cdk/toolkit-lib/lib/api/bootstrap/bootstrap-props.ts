...
export interface BootstrapEnvironmentOptions {
   ...
   *
   * @defaultValue - modern v2-style bootstrapping
   */
...
export interface BootstrappingParameters {
   ...
   *
   * @defaultValue - a name is generated by CloudFormation.
   */
   ...
   *
   * @defaultValue - use the default KMS key or create a custom one
   */
   ...
   *
   * @defaultValue - only the bootstrapped account can deploy into this environment
   */
   ...
   *
   * @defaultValue - only the bootstrapped account can look up values in this environment
   */
   ...
   *
   * @defaultValue - no account will be untrusted.
   */
   ...
   *
   * @defaultValue - the role will have no policies attached
   */
   ...
   *
   * @defaultValue - Default qualifier
   */
   ...
   *
   * @defaultValue - No value, optional argument
   */
