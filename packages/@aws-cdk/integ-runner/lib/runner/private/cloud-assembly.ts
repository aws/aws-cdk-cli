...
import type { FileManifestEntry, DockerImageManifestEntry } from '@aws-cdk/cdk-assets-lib/lib/asset-manifest';
import { AssetManifest } from '@aws-cdk/cdk-assets-lib/lib/asset-manifest';
