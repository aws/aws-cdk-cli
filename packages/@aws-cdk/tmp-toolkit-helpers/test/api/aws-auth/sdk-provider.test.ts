...
import type { ConfigurationOptions, CredentialsOptions, SDK } from '../../../src/api/aws-auth';
import { SdkProvider } from '../../../src/api/aws-auth';
import { AwsCliCompatible } from '../../../src/api/aws-auth/awscli-compatible';
import { defaultCliUserAgent } from '../../../src/api/aws-auth/user-agent';
import { PluginHost } from '../../../src/api/plugin';
import { Mode } from '../../../src/api/plugin/mode';
