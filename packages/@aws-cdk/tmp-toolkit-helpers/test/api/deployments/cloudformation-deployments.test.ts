...
import { CloudFormationStack } from '../../../src/api/cloudformation';
import { Deployments } from '../../../src/api/deployments';
import { createChangeSet } from '../../../src/api/deployments/cfn-api';
import { deployStack } from '../../../src/api/deployments/deploy-stack';
import { HotswapMode } from '../../../src/api/hotswap/common';
import { ToolkitInfo } from '../../../src/api/toolkit-info';
...
jest.mock('../../../src/api/deployments/deploy-stack');
jest.mock('../../../src/api/deployments/asset-publishing');
