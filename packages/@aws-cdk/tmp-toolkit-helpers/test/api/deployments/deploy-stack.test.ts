...
import { assertIsSuccessfulDeployStackResult } from '../../../src/api/deployments';
import type { DeployStackOptions } from '../../../src/api/deployments/deploy-stack';
import { deployStack } from '../../../src/api/deployments/deploy-stack';
import { tryHotswapDeployment } from '../../../src/api/deployments/hotswap-deployments';
import { NoBootstrapStackEnvironmentResources } from '../../../src/api/environment';
...
jest.mock('../../../src/api/deployments/hotswap-deployments');
jest.mock('../../../src/api/deployments/checks', () => ({
