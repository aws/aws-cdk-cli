...
import type { AssetMetadataEntry } from '@aws-cdk/cloud-assembly-schema';
import { AssetManifestBuilder } from '../../../src/api/deployments';
import { addMetadataAssetsToManifest } from '../../../src/api/deployments/assets';
import type { EnvironmentResources } from '../../../src/api/environment';
import { EnvironmentResourcesRegistry } from '../../../src/api/environment';
