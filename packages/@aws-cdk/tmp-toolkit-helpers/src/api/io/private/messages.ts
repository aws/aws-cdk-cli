...
import type { HotswapChange, HotswapDeployment } from '../payloads/hotswap';
...
export const IO = {
  ...
  CDK_TOOLKIT_I5401: make.info<HotswapChange>({
    code: 'CDK_TOOLKIT_I5401',
    description: 'Hotswap deployment resource processing',
    interface: 'HotswapChange',
  }),
  CDK_TOOLKIT_I5402: make.info<HotswapChange>({
    code: 'CDK_TOOLKIT_I5402',
    description: 'Hotswap deployment resource processing finished',
    interface: 'HotswapChange',
  }),
