    ...
    workflow.addJob('add-regression-label', {
      ...
      steps: [
        ...
        },
        {
          ...
          gh issue edit "\$ISSUE_NUMBER" --add-label "potential-regression" -R \${{ github.repository }}
        else
          gh issue edit "\$ISSUE_NUMBER" --remove-label "potential-regression" -R \${{ github.repository }}
        fi`,
        },
      ],
    });
