...
const cli = configureProject(
  new yarn.TypeScriptWorkspace({
    ...
    deps: [
      ...
      toolkitLib,
      'archiver',
      '@aws-sdk/client-appsync@3.908.0',
      '@aws-sdk/client-cloudformation@3.908.0',
      '@aws-sdk/client-cloudwatch-logs@3.908.0',
      '@aws-sdk/client-cloudcontrol@3.908.0',
      '@aws-sdk/client-codebuild@3.908.0',
      '@aws-sdk/client-ec2@3.908.0',
      '@aws-sdk/client-ecr@3.908.0',
      '@aws-sdk/client-ecs@3.908.0',
      '@aws-sdk/client-elastic-load-balancing-v2@3.908.0',
      '@aws-sdk/client-iam@3.908.0',
      '@aws-sdk/client-kms@3.908.0',
      '@aws-sdk/client-lambda@3.908.0',
      '@aws-sdk/client-route-53@3.908.0',
      '@aws-sdk/client-s3@3.908.0',
      '@aws-sdk/client-secrets-manager@3.908.0',
      '@aws-sdk/client-sfn@3.908.0',
      '@aws-sdk/client-ssm@3.908.0',
      '@aws-sdk/client-sts@3.908.0',
      '@aws-sdk/credential-providers@3.908.0',
      '@aws-sdk/ec2-metadata-service@3.908.0',
      '@aws-sdk/lib-storage@3.908.0',
...
const cliInteg = configureProject(
  new yarn.TypeScriptWorkspace({
    ...
    deps: [
      ...
      '@aws-sdk/client-codeartifact@3.908.0',
      '@aws-sdk/client-cloudformation@3.908.0',
      '@aws-sdk/client-ecr@3.908.0',
      '@aws-sdk/client-ecr-public@3.908.0',
      '@aws-sdk/client-ecs@3.908.0',
      '@aws-sdk/client-iam@3.908.0',
      '@aws-sdk/client-lambda@3.908.0',
      '@aws-sdk/client-s3@3.908.0',
